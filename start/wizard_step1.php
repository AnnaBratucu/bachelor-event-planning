...
<div class="row" style="margin-left:80px;">
  ...
  <div class="column">
    <p style="color:black;">Date Max: <input type="text" name="date_max" id="datepicker1" required><i class="fas fa-calendar-day" style="color:black;top:0px;left:-50px;"></i></p>
  </div>
</div>
