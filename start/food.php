...
<li class="darkerli">
<?php if($novenue == true){ ?>
    <a href="wizard_novenue.php?event_id=<?php echo $_GET[ 'event_id' ] ?>" >
<?php } else{ ?>
...
<div class="row" style="margin-left:80px;">
  <div class="column">
    <p style="color:black;">Date Min: <input type="text" name="date_min" id="datepicker" required value="<?php if( isset($_SESSION[ 'date_max' ])) echo $_SESSION[ 'date_min' ] ?>"><i class="fas fa-calendar-day" style="color:black;top:0px;left:-50px;"></i></p>
  </div>
  <div class="column">
    <p style="color:black;">Date Max: <input type="text" name="date_max" id="datepicker1" required value="<?php if(isset($_SESSION[ 'date_max' ])) echo $_SESSION[ 'date_max' ] ?>"><i class="fas fa-calendar-day" style="color:black;top:0px;left:-50px;"></i></p>
  </div>
</div>
