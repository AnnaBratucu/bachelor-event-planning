...
<?php } ?>
			...
			<?php } ?>
				...
				<?php } ?>
					<div class="row" style="margin-left:300px;">
						<div class="column1bis">
							<select id="category" name="category" class="form-control">
								<?php if( !isset( $_SESSION[ 'food_search_category' ] ) ){ ?>
									<option value="" disabled selected>Category</option>
								<?php }else{ ?>
									<option value="" disabled>Category</option>
								<?php } ?>
								<?php if( $_SESSION[ 'food_search_category' ] == 'starters' ){ ?>
									<option value="starters" selected>Starters</option>
								<?php } else{ ?>
									<option value="starters">Starters</option>
								<?php } 
								if( $_SESSION[ 'food_search_category' ] == 'salad' ){ ?>
									<option value="salad" selected>Salad</option>
								<?php }else{ ?>
									<option value="salad">Salad</option>
								<?php } ?>
								<?php if( $_SESSION[ 'food_search_category' ] == 'entree' ){ ?>
									<option value="entree" selected>Entree</option>
								<?php } else{ ?>
									<option value="entree">Entree</option>
								<?php } 
								if( $_SESSION[ 'food_search_category' ] == 'dessert' ){ ?>
					...
					<div class="row" style="margin-left:-75px;margin-top:125px;margin-bottom:-10px;">
...
if( $_SESSION['username'] != 'admin@yahoo.com' ){
  ...
  $venue_id = $profile[ 'venue_id' ];
			...
			if( $_SESSION['username'] == 'admin@yahoo.com' ){
				...
				$sql = "SELECT * FROM food WHERE venue_id =$venue_id";
			}
				...
				if($_SESSION['username'] == 'admin@yahoo.com'){
					...
					$sql2 = "SELECT * FROM food WHERE venue_id =$venue_id
					" . ( isset($_SESSION[ 'food_search_category' ]) && $_SESSION[ 'food_search_category' ] != '' ? " AND food_category = '" . $_SESSION[ 'food_search_category' ] . "'"  : "" ) . "
					...
					LIMIT $startFrom, $showRecordPerPage";
						...
						while($venue = $stmt2->fetch()) {
							...
							if($stmt1 = $pdo->prepare($sql1)){
								// Bind variables to the prepared statement as parameters
								$stmt1->execute(['food_id' => $venue[ 'food_id' ]]); 
									...
									<div class="product_info d-flex flex-row align-items-start justify-content-start">
										<div>
											<div>
												...
												<?php if( $_SESSION[ 'username' ] != 'admin@yahoo.com' && $food_count > 0 ){ ?><div style="color:red;">CHOSEN</div><?php } ?>
											</div>
										</div>
									...
									<div class="product_buttons">
										<div class="text-right d-flex flex-row align-items-start justify-content-start">
											<div class="product_button product_fav text-center d-flex flex-column align-items-center justify-content-center">
												...
												<?php } else { ?>
													<a href="../start/see_food.php?food_id=<?php echo $venue[ 'food_id' ] ?>&event_id=<?php echo $_GET[ 'event_id' ] ?>"><div class="plus" data-toggle="tooltip" title="See details!" data-placement="top"><div class="plus"><img src="images/eye_2.png" class="svg" alt="" data-toggle="tooltip" title="See details!" data-placement="top" height="40"><div class="plus">+</a></div></div></div>
												<?php } ?>
											</div>
									...
									<div class="product_buttons">
										<div class="text-right d-flex flex-row align-items-start justify-content-start">
											<div class="product_button product_fav text-center d-flex flex-column align-items-center justify-content-center">
												...
												<a href="delete_food.php?food_id=<?php echo $venue[ 'food_id' ] ?>" onclick="if (!confirm('Are you sure you want to delete?')) { return false; }"><div class="plus" data-toggle="tooltip" title="Delete!" data-placement="top"><div class="plus"><img src="images/trash.png" class="svg" alt="" data-toggle="tooltip" title="Delete!" data-placement="top" height="40"><div class="plus">-</a></div></div></div>
