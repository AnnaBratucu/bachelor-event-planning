...
<?php } ?>
			...
			<?php } ?>
				...
				<?php if( $_SESSION[ 'username' ] != 'admin@yahoo.com' ){ ?>
					<form autocomplete="off" style="margin-bottom:-80px;margin-top:20px;" action="../start/venue_search.php?event_id=<?php echo $_GET[ 'event_id' ]; ?>" class="row" method="post"> 
				<?php } else{ ?>
					<form autocomplete="off" style="margin-bottom:-80px;margin-top:20px;" action="../start/venue_search.php" class="row" method="post"> 
				<?php } ?>
